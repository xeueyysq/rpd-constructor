  ...
  return (
    <div>
      ...
      <div className="tamplate">
        Рабочая программа разработана в соответствии с требованиями ФГОС ВО по
        направлению подготовки высшего образования 09.03.01 Информатика и
        вычислительная техника <br />
        <span>направление указывает РОП</span> <br />
      </div>
      <div className="tamplate">
        Программа рассмотрена на заседании кафедры распределенных информационных
      ...
      <div className="tamplate">Заведующий кафедрой</div>
      <div>
        ___________________д. т. н. профессор Кореньков В.В.
        <br />
        <span>Где брать заведующего кафедрой?</span>
      </div>

      <div>
        <div className="tamplate">СОГЛАСОВАНО</div>
        <div>
          Заведующий кафедрой САУ ___________________д. т. н. профессор
          Черемисина Е.Н. <br />
          <span>Где брать заведующего кафедрой?</span>
        </div>
      </div>
      <div className="tamplate">
        ...
        Федерального государственного бюджетного учреждения «Всероссийский
        научноисследовательский геологический нефтяной институт» <br />
