  ...
  return (
    <div>
      ...
      <div className="tamplate">
        ...
        образования 09.03.01 Информатика и вычислительная техника <br />
      ...
      <div>
        ...
        <div>
          Заведующий кафедрой САУ ___________________д. т. н. профессор Черемисина Е.Н. <br />
          <span>Где брать заведующего кафедрой?</span>
        </div>
      </div>
      <div className="tamplate">
        Эксперт: <br />
        Марков Кирилл Николаевич кандидат технических наук заведующий отделом Федерального государственного бюджетного
        учреждения «Всероссийский научноисследовательский геологический нефтяной институт» <br />
